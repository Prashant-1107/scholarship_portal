...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Since `user` state takes a cycle to update after login, 
      // we check the role from local logic or fallback to dashboard.
      // The ProtectedRoute handles actual access control.
      ...
      <div className="flex-1 flex flex-col justify-center py-12 px-4 sm:px-6 lg:flex-none lg:w-1/2 lg:px-20 xl:px-24">
        <div className="mx-auto w-full max-w-sm lg:max-w-md">
          ...
          <div className="flex items-center gap-2 mb-10 lg:hidden">
            ...
            <span className="text-3xl font-bold tracking-tight text-gray-900">Virtusscholar</span>
          </div>
          ...
          <div>
            ...
            <p className="text-base text-gray-600">
              ...
              <Link to="/register" className="font-medium text-[#0D9488] hover:text-teal-700 transition-colors">
                Create one now <ArrowRight className="inline w-4 h-4 ml-0.5 -mt-0.5" />
              </Link>
            </p>
          </div>
          ...
          <div className="mt-10">
              ...
              <div>
                ...
                <div className="mt-2">
                  <input
                    ...
                    placeholder="student1@virtusscholar.com"
                  />
                </div>
              </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200 text-center">
              <Link to="/admin-access" className="text-sm font-medium text-gray-500 hover:text-[#0D9488] transition-colors">
      ...
      <div className="hidden lg:flex relative w-0 flex-1 bg-[#0D9488] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 px-12 max-w-2xl text-left">
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-3xl font-bold tracking-tight text-white">Virtusscholar</span>
          </div>
