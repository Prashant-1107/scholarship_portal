...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F6F0] text-stone-900 selection:bg-amber-300/40 selection:text-stone-950 overflow-x-hidden transition-colors">
      ...
      {/* Challenge Compliance Banner: WEB-004(2) */}
      <section className="relative py-14 z-10 border-t border-stone-200/80 bg-[#FEF6DF]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center space-y-3">
          <Badge className="bg-amber-100 text-amber-900 border border-amber-300 px-3 py-1 text-xs">
            COMPLIANCE VERIFICATION
          </Badge>
          <h2 className="font-bold text-2xl sm:text-3xl text-stone-950 tracking-tight">
            TEZHACK 2026 Test Protocol: WEB-004(2)
          </h2>
          <p className="text-xs sm:text-sm text-stone-700 max-w-2xl mx-auto">
            &ldquo;Save two records, remove one, and reload the saved list.&rdquo; &mdash; Backed by local storage persistence with dedicated evaluation buttons at <code className="text-amber-900 bg-amber-100/80 px-1.5 py-0.5 rounded border border-amber-300/60">/my-scholarships</code>.
          </p>
          <div className="pt-2">
            <Link to="/my-scholarships">
              <Button size="sm" className="bg-stone-950 hover:bg-black text-white text-xs rounded-full px-5 py-2 font-bold shadow-xs">
                Open Save-For-Later Testbed
              </Button>
            </Link>
          </div>
        </div>
